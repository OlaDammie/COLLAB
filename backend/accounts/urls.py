...
from .views import HomePageView, SignUpView, Login, Logout, Done, SendOtp, Check, Password_reset, archive_note_view, archive_page_view, unarchive_note_view, trash_note, trash_page_view, delete_note_permanently, save_note, search_function
